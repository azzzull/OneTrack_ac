...
export default function NotificationCenter({ compact = false, align = "right" }) {
    ...
    useEffect(() => {
        if (!open && !toastNotification) return undefined;
    ...
    }, [open, toastNotification, updateFloatingPosition]);
                  ...
                  <>
                      {open && (
                          <div
                              ...
                              className="fixed z-[2147483647] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl"
                          >
