            ...
            <div className={className}>
                ...
                <div className="mt-3 space-y-2 text-sm text-slate-700">
                    <p>
                        ...
                        {getDisplayValue(acDetails?.brand)}
                    </p>
                    <p>
                        <span className="font-medium">Tipe AC:</span>{" "}
                        {getDisplayValue(acDetails?.type)}
                    </p>
                    <p>
                        <span className="font-medium">Kapasitas AC:</span>{" "}
                        {getDisplayValue(acDetails?.capacity)}
                    </p>
                    <p>
                        <span className="font-medium">Lokasi Ruangan:</span>{" "}
                        {getDisplayValue(acDetails?.roomLocation)}
                    </p>
                    <p>
                        <span className="font-medium">Serial Number:</span>{" "}
                        {getDisplayValue(acDetails?.serialNumber)}
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className={className}>
            ...
            <div className="mt-3 space-y-2 text-sm text-slate-700">
                ...
                {checklist.length > 0 && (
                    <div>
                        <p className="font-medium">Checklist Pekerjaan:</p>
