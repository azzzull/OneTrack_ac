    ...
    if (todayStatus === "not_checked_in") {
        return (
            <button
                ...
                className="px-6 py-3 bg-linear-to-r from-sky-500 to-sky-600 text-white rounded-lg hover:from-sky-600 hover:to-sky-700 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium flex items-center gap-2 shadow-md"
            >
                {attendanceLoading ? (
...
function showErrorToast(message) {
    ...
    const toast = document.createElement("div");
    toast.className =
        "bg-red-500 text-white px-4 py-3 rounded-lg shadow-lg animate-fade-in-up mb-2";
    toast.textContent = message;
