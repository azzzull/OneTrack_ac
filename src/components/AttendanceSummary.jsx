...
import { useAttendance, formatTimeShort, formatWorkingHours } from '../hooks/useAttendance';
...
const AttendanceSummary = ({ technicianId }) => {
    ...
    return (
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-gray-700 font-medium">
          <AlertCircle className="inline mr-2 text-blue-500" size={18} />
  ...
  const workingHours = formatWorkingHours(attendanceData.working_hours_minutes);
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gray-900">
              Absen Masuk: <span className="text-blue-600">{checkInTime}</span>
            </span>
          </div>
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gray-900">{checkOutTime}</span>
          </div>
          <div className="ml-6 mt-1">
            <p className="text-sm text-gray-600">
              {formatAddressShort({
